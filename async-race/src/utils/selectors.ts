const SELECTORS = {
  ...
  SORT_BY_TIME_ICON: '.winner__sort-icon_type_time',
  SORT_BY_WINS_ICON: '.winner__sort-icon_type_wins',
  WINNER_SORT_ICON_HIDDEN: 'winner__sort-icon_state_hidden',
  WINNER_SORT_ICON_ROTATED: 'winner__sort-icon_state_rotated',
  ALERT: '.alert',
